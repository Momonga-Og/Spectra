...
class Profession(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.file_path = '/mnt/data/Professions.xlsx'
...
class ProfessionView(discord.ui.View):
    def __init__(self, profession_options, file_path):
        ...
        self.add_item(ProfessionSelect(profession_options))

class ProfessionSelect(discord.ui.Select):
    def __init__(self, profession_options):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        df = pd.read_excel(self.view.file_path, sheet_name=selected_profession)
